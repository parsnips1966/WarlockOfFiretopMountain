...
def checkpoint_5():
    if vars.decision_16 == "EAST":
        ...
        story("The passage ends at a solid wooden door with metal hinges. Listening at the door,\nyou hear strange "
              "mutterings and the clatter of what could be pots and pans.")
        vars.decision_17 = story("Whatever is in there, there are several of them.\nDo you want to go through the door?"
                                 )
        if vars.decision_17 == "YES":
            ...
            story("You open the door into a large room which can only only be the dining room\nof the same "
                  "warty-faced creatures you now recognise.")
            story("Sitting around a large table are five Orcs busily drinking\nand dribbling their bowls of "
                  "rat-gizzard soup.")
            story("All are involved in a rowdy arguement as to who will get to chew the rat bones\nleft in the large "
                  "soup cauldron, so they do not see you enter.")
            vars.decision_18 = story("Will you be bold and prepare to ATTACK them or, if you don't relish the "
                                     "prospect\nof taking on five of these creatures, try to ESCAPE?")
            if vars.decision_18 == "ESCAPE":
                            ...
                            if fight("Fourth Orc", 1):
                                ...
                                if fight("Fifth Orc", 1):
                                    ...
                                    story("You search the bodies of the dead Orcs but find only\na few teeth, nails, "
                                          "bones and knives in their pockets.")
                                    story("You search the cupboards around the room\nbut find only crude bowls, "
                                          "plates and spoons.")
                                    vars.decision_19 = story("But under the serving hatch you find a thin "
                                                             "leather\ncase half a metre long. Do you want to open it?")
                                    if vars.decision_19 == "YES":
                                        story("The case opens easily and inside you find a magnificent bow and one "
                                              "silver arrow.")
                                        story("An inscription on the case says: 'The giver of sleep to those who "
                                              "never can'.")
                                        vars.decision_20 = story("Do you want to eat Provisions" + provs_tuto() + " here?")
                                        if vars.decision_20 == "YES":
                                            take_provs()
                                        change_stats(2, 1)
                                        vars.equipment.append("Bow And Arrow")
                                        story("You put the bow, arrow and case in your pack and leave the room.")
                                        vars.decision_17 = "NO"
                                    elif vars.decision_19 == "NO":
    ...
    if vars.decision_16 == "NORTH":
        ...
        story("You see a well-used door on the right-hand(east) side of the passageway.\nWith your ear to the "
              "keyhole, you hear a man screaming for help from inside.")
        vars.decision_21 = story("Will you OPEN the door or WALK on?")
        if vars.decision_21 == "OPEN":
