...
def checkpoint_5():
    if vars.decision_16 == "EAST":
        ...
        if vars.decision_17 == "YES":
            ...
            vars.decision_18 = story("Will you be bold and prepare to ATTACK them or, if you don't relish the prospect\nof taking on five of these creatures, try to ESCAPE?")
                        ...
                        if fight("Third Orc", 1):
                            ...
                            if fight("Fourth Orc", 1):
                                ...
                                if fight("Fifth Orc", 1):
                                    ...
                                    vars.decision_19 = story("But under the serving hatch you find a thin leather\ncase half a metre long. Do you want to open it?")
