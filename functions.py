...
def autosave() -> None:
    account_data = {"gold": vars.gold, "provs": vars.provs, "hero": vars.hero, "init_hero": vars.init_hero, "equipment": vars.equipment, "river": vars.river, "piranhas": vars.piranhas,
"fight_tuto_done": vars.fight_tuto_done, "provs_tuto_done": vars.provs_tuto_done, "checkpoint": vars.checkpoint, "profile_name": vars.profile_name,
