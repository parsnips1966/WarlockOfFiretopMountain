...
def checkpoint_7():
    if vars.decision_28 == "LEFT":
        ...
        story("Although it looked like a handle, it was in fact a wax-coated sword blade and\nit has now cut your "
              "hand badly. Did you use your right or left hand.")
        story("Roll one die.")
        ...
        vars.decision_28 = "RIGHT"
    if vars.decision_28 == "RIGHT":
        vars.background = "portcullis"
        story("You hear a deep rumbling noise and the ground begins to shudder.\nSlowly and noisily the portcullis "
              "rises into the celing.")
        vars.background = "passage"
        vars.decision_29 = story("You may now walk to the junction.\nWill you turn WEST or EAST?")
        if vars.decision_29 == "WEST":
            vars.decision_30 = story("Shortly you arrive at another junction where you may go either\nstraight ahead "
                                     "WESTwards or turn NORTHwards. Which will you choose?")
            if vars.decision_30 == "NORTH":
                story("The passage runs for some distance northwards and then starts to open into a\nlarge cavern "
                      "with rough walls. There appears to be no way through.")
                vars.decision_31 = story("Will you RETURN to the junction or ENTER the cavern?")
                if vars.decision_31 == "ENTER":
                    story("As you enter the cavern you hear loud footsteps, crunching heavily on the\nrocky floor. "
                          "You crouch down beside the entrance in a small alcove.")
                    ...
                    story("He stands over two metres tall and is dressed in ill-fitting garments\nmade from some sort "
                          "of hide. He carries a large wooden club. Will you:")
                    vars.decision_32 = story("ATTACK him as he enters?\nTry to CREEP out without him noticing?\nTry "
                                             "to DISTRACT him by throwing something into a far corner?")
                    if vars.decision_32 == "CREEP":
                        ...
                        if len(vars.equipment) == 0:
                            ...
                            vars.decision_33 = story("You open your pack and reach inside for something\nsuitable to "
                                                     "throw. Which item will you choose to throw?")
                            while vars.decision_33.title() not in vars.equipment:
                                vars.decision_33 = story("You don't have that. Which piece of equipment will you "
                                                         "choose from your pack?")
                            vars.equipment.remove(vars.decision_33.title())
                            story("You throw the " + vars.decision_18 +
                                  " across the cavern\nwhere it lands with a clatter.")
                            story("The Ogre looks towards the noise, and goes over to investigate.\nMeanwhile you "
                                  "creep out, down the passage and back to the junction.")
                            vars.decision_31 == "RETURN"
                    if vars.decision_32 == "ATTACK":
            ...
            vars.decision_36 = story("Do you want to eat Provisions" + provs_tuto() + " here?")
            if vars.decision_36 == "YES":
                take_provs()
                story("As you sit on the bench and eat, you begin to feel deeply relaxed and the\naches from your "
                      "body seem to sooth themselves away. This place is enchanted")
                change_stats(1, 2)
                change_stats(0, 1)
                story("You restore 2 additional Stamina as well\nas the normal amount and 1 Skill point.")
                vars.decision_36 = "NO"
            if vars.decision_36 == "NO":
                vars.decision_37 = story("You arrive at another junction in the passageway.\nWould you like to turn "
                                         "WEST or EAST?")
                if vars.decision_37 == "WEST":
                    story("You follow the passage westwards, then it turns sharply to the north and,\nsome metres "
                          "further on, a passage runs off to the west.")
                    vars.decision_38 = story("Would you like to go along the WESTwards passage or carry on NORTHwards?")
                    if vars.decision_38 == "WEST":
                        story("As you walk, it visibly widens and eventually you find yourself\nstanding at the mouth "
                              "of a rough cavern, a natural cave in the rock.")
                        story("As you look into the darkness, the cavern appears\nto be about 30 metres deep, "
                              "with no visible exit.")
                        vars.decision_39 = story("Do you want to go INTO the cavern or go BACK to the junction?")
                        if vars.decision_39 == "INTO":
                            story("You enter the cavern and look around to see dozens of beautifully\ncoloured "
                                  "stalactites and stalagmites bordering the perimeter.")
                    ...
                    if vars.decision_38 == "NORTH":
                        ...
                        if vars.decision_41 == "KNOCK":
                            ...
                            if vars.decision_42 == "START":
                                ...
                                story("The old man chuckles and says, 'You poor fool. Did you think I "
                                      "was\ndefenceless in such a den of evil as this? Regret your folly.'")
                                story("You rise to your feet and return to the passageway, turning north up the "
                                      "corridor.")
                                vars.decision_41 = "CONTINUE"
                            if vars.decision_42 == "LEAVE":
                                vars.decision_41 = "CONTINUE"
                        if vars.decision_41 == "CONTINUE":
                            vars.background = "door"
                            story("Northwards the passageway ends at a solid wooden door.\nYou listen at the door but "
                                  "can hear nothing.")
                            story("There appears to be no choice but to open the door and\nenter the room, which you "
                                  "do. It's a large square room.")
                            story("You flash your lantern around and glimpse its emptiness - although\nthere are "
                                  "murals on the wall - before your lantern suddenly dies.")
                            story("You try to re-light it, but it will not catch. In the\nblackness you hear a "
                                  "succession of frightful noises.")
                            story("Howls, screams, cries and wails are getting louder and louder\nuntil they reach "
                                  "the pitch where you must cover your ears.")
                            if "Blue Candle" not in vars.equipment:
                                ...
                                vars.decision_44 = story("On the wall opposite is another door.\nWill you LEAVE "
                                                         "through it or STAY to investigate?")
                                if vars.decision_44 == "LEAVE":
                                    vars.checkpoint = 9
                                elif vars.decision_44 == "STAY":
                                    story("As you watch the living mural, you are unaware of the speed\nyour candle "
                                          "is burning. Suddenly it flickers and goes out!")
                                    story("You again begin to hear the piercing screams\nand their pitch grows to an "
                                          "unbearable level.")
                                    story("You drop to your knees clutching your ears and crawl towards\nthe wall. "
                                          "Which wall will you crawl towards:")
                            if vars.decision_44 == "STAY":
                                vars.decision_45 = story("The EAST wall?\nThe NORTH wall?\nThe WEST wall?")
                                if vars.decision_45 == "EAST":
                                    story("You run along the wall searching for a door but find none.\nYour ears are "
                                          "on fire with the agony!")
                                    change_stats(0, 1, "subtract")
                                    vars.decision_46 = story("You may either try the WEST wall or the NORTH wall,"
                                                             "\nbut you must find a way out soon! Which will you "
                                                             "choose?")
                                    if vars.decision_46 == "WEST":
                                        story("You grope along the wall but can find no way of escape.\nThe noise of "
                                              "causing you to scream in pain!")
                                        change_stats(0, 1, "subtract")
                                        story("You try the north wall.")
                                        vars.decision_45 = "NORTH"
                                    elif vars.decision_46 == "NORTH":
                                        vars.decision_45 = "NORTH"
                                if vars.decision_45 == "WEST":
                                    story("You grope along the wall but can find no way of escape.\nThe noise of "
                                          "causing you to scream in pain!")
                                    change_stats(0, 1, "subtract")
                    ...
                    if vars.decision_46 == "NORTH":
                        ...
                        vars.decision_47 = story("The passageway ends in a sturdy wooden door. Do you\nwant to try "
                                                 "OPENing it or go back and try another ROUTE?")
