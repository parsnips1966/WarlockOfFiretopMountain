...
def checkpoint_4():
    if vars.decision_8 == "YES":
        ...
        if vars.decision_9 == "LEAP":
            ...
            if fight("First Orc"):
                vars.monster = [5, 5]
                if fight("Second Orc"):
                    story("You wipe your bloodied sword on the mattress. The green blood\nleaves a slimy stain on the "
                          "straw mattress.")
                    vars.background = "box"
                    story("Stepping over the bodies towards the table, you pick up the box from under the table\nand "
                          "examine it. It is a small wooden box with crude hinges.")
                    vars.decision_10 = story("The name Farrigo Di Maggio is inscribed on a brass namplate on its "
    ...
    if vars.decision_8 == "NO":
        ...
        vars.decision_9 = story("You eventually arrive at the end of the passage, at a three-way junction.\nWill you "
                                "turn either to the WEST or to the EAST?")
        if vars.decision_9 == "WEST":
            ...
            story("The passageway runs straight for several metres and then ends in a wooden door.\nYou listen at the "
                  "door and hear angry shouting coming from within.")
            ...
            if vars.decision_11 == "YES":
                ...
                if vars.decision_12 == "CHIEFTAIN":
                    ...
                    story("As you spring at the Chieftain, his servant rises to his feet, picks up a hefty club\nand "
                          "joins the melee. But to your horror he attacks you!")
                    vars.decision_13 = story("Seeing this will you ESCAPE through the door down the corridor or "
                                             "CONTINUE the fight.")
                    ...
                    if fight("Orc Chieftain"):
                        ...
                        if fight("Servant"):
                            story("The green blood of the dead Orcs smells foul as it seeps from their bodies.\nYou "
                                  "step around the corpses and investigate the chest.")
                            vars.background = "box"
                            ...
                            vars.decision_14 = story("Will you try to SMASH the lock with your sword\nor leave it "
                                                     "alone and GO through the open door?")
                            if vars.decision_14 == "SMASH":
                                story("The lock was obviously inadequate; it flies off\nand lands on the floor "
                                      "several metres away.")
                                story("You lift up the heavy lid and your eyes widen as you see the gold "
                                ...
                                story("In a corner lies a small black bottle with a tight stopper,\ncontaining some "
                                      "kind of liquid. Also in the chest is a silky black glove.")
                                ...
                                change_stats(1, vars.dice_num, "subtract")
                                if vars.hero[1] > 0:
                                    story("You sink to the floor. You pull the dart out and decide to bandage the "
                                    ...
                                    story("There are 25 Gold Pieces and the bottle label shows it to be a\nPotion of "
                                          "Invisibility, good for one dose. The glove is a mystery.")
                                    vars.gold += 25
