...
def checkpoint_9():
    ...
    vars.decision_64 = story("Will you DRINK from the fountain? Or PASS\nit by and leave through a door in the north wall?")
    if vars.decision_64 == "DRINK":
        ...
        vars.decision_65 = story("The fountain of life for you must be death for\nthe evil Goblins. Will you eat Provisions " + provs_tuto() + " here?")
        if vars.decision_65 == "YES":
            change_stats(1, 4)
        vars.background = "door"
        story("When you have rested, leave through the north door.")
        vars.decision_64 = "PASS"
    if vars.decision_64 == "PASS":
        ...
        vars.decision_66 = story("Several metres on, you reach a junction at which\nyou may either go NORTH or continue EASTwards. Which will you choose?")
        if vars.decision_66 == "EAST":
            vars.background = "door"
            story("The passage twists and turns and eventually ends in\na solid iron door. You listen but hear nothing.")
            vars.decision_67 = story("Will you try to OPEN the door or you can go BACK to the junction?")
            if vars.decision_67 == "OPEN":
                ...
                vars.decision_68 = story("Try on the BRONZE helmet?\nTry on the IRON helmet?\nRETURN to the junction?")
                if vars.decision_68 == "BRONZE":
                    vars.equipment.append("Bronze Helmet")
                    ...
                    vars.decision_67 = "BACK"
                elif vars.decision_68 == "IRON":
                    ...
                    #make work
                    vars.decision_67 = "BACK"
                if vars.decision_68 == "RETURN":
                    vars.decision_67 = "BACK"
            if vars.decision_67 == "BACK":
                vars.background = "passage"
                story("You arrive back at the junction and this time turn northwards.")
                vars.decision_66 = "NORTH"
        if vars.decision_66 == "NORTH":
            vars.decision_69 = story("Some way up, you reach another junction where you\nmay either go EASTwards or turn WESTwards. Which will you choose?")
            if vars.decision_69 == "EAST":
                ...
                if fight("First Caveman"):
                    ...
                    if fight("Second Caveman"):
                        story("You leave the cavern and return to the junction to progress westwards.")
                        vars.decision_69 = "WEST"
            if vars.decision_69 == "WEST":
                vars.background = "passage"
                story("The passageway twists sharply northwards and ahead you can hear water flowing.")
                vars.background = "river"
                ...
                vars.decision_70 = story("Will you FIGHT these three as a single creature or ESCAPE?")
                if vars.decision_70 == "FIGHT":
                    vars.monster = [6, 6]
                    if fight("Giant Bats"):
                        ...
                        vars.decision_71 = story("A mysterious voice speaking in your mind seems to be\ntelling you to throw your own sword into the river. Will you?")
                        if vars.decision_71 == "YES":
                            ...
                            vars.decision_70 = "ESCAPE"
                        elif vars.decision_71 == "NO":
                        ...
                        checkpoint_11()
                        vars.escape = False
                elif vars.decision_70 == "ESCAPE":
                    vars.checkpoint = 11
                    change_stats(1, 2, "subtract")
            if vars.decision_70 == "ESCAPE":
                vars.checkpoint = 11
                checkpoint_11()